...
public class ServicesImpl implements ILabServices {
    ...
    public ServicesImpl(EmployeeDbRepository employeeDbRepository, ShowDbRepository showDbRepository, TicketDbRepository ticketDbRepository) {
