...
public class Detaliu_AdminController implements Observer<EntityChangeEvent> {
    @FXML
    ...
    public void handleAprobare(){
        currentMasina.setStatur_curent(Status.APPROVED);
        service.update_masina(currentMasina);
    }

    public void handleRespingere(){
        currentMasina.setStatur_curent(Status.REJECTED);
        service.update_masina(currentMasina);
    }
